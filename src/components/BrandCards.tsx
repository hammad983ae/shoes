          ...
          {brands.map((brand, index) => (
            ...
            >
              <div className="relative h-64 sm:h-72 md:h-80 w-full rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-transparent group-hover:from-hsl(var(--brand-yellow))/20 group-hover:via-hsl(var(--brand-charcoal))/10 group-hover:to-hsl(var(--brand-black))/20 transition-all duration-500" />
                ...
                <div className="absolute inset-0 rounded-lg group-hover:shadow-[0_0_30px_hsl(var(--brand-yellow))/40] transition-shadow duration-500" />
              </div>
            </div>
          ))}
        </div>
