...
const AnnouncementBar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-semibold text-center py-2 relative z-10">
      {/* Shared Container for Page Center Alignment */}
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative">
        {/* Left Arrow */}
        <button
          onClick={goToPrevious}
          className="absolute left-3 top-1/2 -translate-y-1/2 p-1 md:p-1.5 rounded-full bg-black/20 hover:bg-black/30 text-white transition-all duration-200 z-20 flex items-center justify-center"
