// Service Worker registration for offline persistence and faster app recovery
...
export function createEnhancedServiceWorker() {
  if ('serviceWorker' in navigator) {
    // Register a more advanced service worker for offline persistence
