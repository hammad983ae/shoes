-- Create the missing is_admin() function that's referenced throughout RLS policies
...
-- Create helper function to get current user role (also referenced in some policies)
...
-- Ensure the admin_set_coupon_code function exists and works properly
