-- Fix the payout_video_credits function to use valid type values
...
BEGIN
  ...
  -- Add to credits history for dashboard display (using 'in' as type)
  INSERT INTO public.credits_history (profile_id, action, type, credits, date)
  VALUES (creator_user_id, 'Video posted', 'in', credits_added, CURRENT_DATE);
