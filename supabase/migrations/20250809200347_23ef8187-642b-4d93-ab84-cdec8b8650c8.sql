...
-- Create unique index for case-insensitive code uniqueness
CREATE UNIQUE INDEX IF NOT EXISTS coupon_codes_code_lower_unique 
ON public.coupon_codes (LOWER(code));
